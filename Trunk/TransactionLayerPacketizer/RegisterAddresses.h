...
enum REGISTER_ADDRESS_NAMES_CFG
{
	...
	RA_CFG_PHY_CAP			= 0x002,
	RA_CFG_LINK_TRAN		= 0x004,
	RA_CFG_RESERVED_LINK	= 0x006,
	RA_CFG_GENERIC_SETTINGS	= 0x008,
	RA_CFG_PHY_SETTINGS		= 0x00A,
	RA_CFG_LINK_TRAN_SETTINS= 0x00C,
	RA_CFG_RESERVED1		= 0x00E,
	RA_CFG_PRESET			= 0x040,
	RA_CFG_RESERVED2		= 0x042,
};
